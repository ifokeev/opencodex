...
const tauriMac = "Mozilla/5.0 (Macintosh; Intel Mac OS X 14_0) AppleWebKit/605.1.15 OpenCodexDesktop/2.61.0";
const tauriWindows = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 OpenCodexDesktop/2.61.0";
const tauriLinux = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 OpenCodexDesktop/2.61.0";
