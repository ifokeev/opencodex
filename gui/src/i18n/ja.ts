...
"common.discard": "破棄",
 ...
 "logs.filter.conversation.clear": "クリア",
  ...
  "usage.companion.installTitle": "メニューバーアプリをインストール",
  "usage.companion.installStep1": "最新リリースから OpenCodex-<version>-macos-universal.zip をダウンロードし、OpenCodex.app をアプリケーションに移動します。",
  "usage.companion.installStep2": "初回起動：OpenCodex.app を右クリックして「開く」を選択します（アドホック署名のため、Gatekeeper の確認は一度だけです）。",
  "usage.companion.installStep3": "アプリはこのプロキシを自動検出します。アプリを一度起動するとウィジェットギャラリーに表示されます。",
