...
"common.discard": "丢弃",
 ...
 "logs.filter.conversation.clear": "清除",
  ...
  "usage.companion.installTitle": "安装菜单栏应用",
  "usage.companion.installStep1": "从最新版本下载 OpenCodex-<version>-macos-universal.zip，并将 OpenCodex.app 拖到应用程序。",
  "usage.companion.installStep2": "首次启动：右键点击 OpenCodex.app 并选择“打开”（应用使用临时签名，因此 Gatekeeper 只会询问一次）。",
  "usage.companion.installStep3": "应用会自动找到此代理；应用运行后，小组件会出现在小组件图库中。",
