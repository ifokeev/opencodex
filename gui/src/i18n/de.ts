...
"common.discard": "Verwerfen",
 ...
 "logs.filter.conversation.clear": "Löschen",
  ...
  "usage.companion.installTitle": "Menüleisten-App installieren",
  "usage.companion.installStep1": "Laden Sie OpenCodex-<version>-macos-universal.zip aus der neuesten Veröffentlichung herunter und ziehen Sie OpenCodex.app in Programme.",
  "usage.companion.installStep2": "Erster Start: Klicken Sie mit der rechten Maustaste auf OpenCodex.app → Öffnen (die App ist nur ad-hoc signiert, daher fragt Gatekeeper einmal).",
  "usage.companion.installStep3": "Die App findet diesen Proxy selbst; das Widget erscheint in der Widget-Galerie, sobald die App ausgeführt wurde.",
