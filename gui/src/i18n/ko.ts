...
"common.discard": "버리기",
 ...
 "logs.filter.conversation.clear": "지우기",
  ...
  "usage.companion.installTitle": "메뉴 막대 앱 설치",
  "usage.companion.installStep1": "최신 릴리스에서 OpenCodex-<version>-macos-universal.zip을 다운로드하고 OpenCodex.app을 응용 프로그램으로 드래그하세요.",
  "usage.companion.installStep2": "첫 실행: OpenCodex.app을 마우스 오른쪽 버튼으로 클릭하고 열기를 선택하세요(앱이 애드혹 서명되어 Gatekeeper가 한 번 확인합니다).",
  "usage.companion.installStep3": "앱이 이 프록시를 자동으로 찾습니다. 앱을 실행하면 위젯 갤러리에 위젯이 표시됩니다.",
