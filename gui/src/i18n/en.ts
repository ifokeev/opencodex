...
"common.discard": "Discard",
 ...
 "logs.filter.conversation.clear": "Clear",
  ...
  "usage.companion.installTitle": "Install the menu bar app",
  "usage.companion.installStep1": "Download OpenCodex-<version>-macos-universal.zip from the latest release and drag OpenCodex.app to Applications.",
  "usage.companion.installStep2": "First launch: right-click OpenCodex.app → Open (the app is ad-hoc signed, so Gatekeeper asks once).",
  "usage.companion.installStep3": "The app finds this proxy on its own; the widget appears in the widget gallery once the app has run.",
