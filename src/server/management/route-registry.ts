...
export const MANAGEMENT_ROUTES: readonly ManagementRoute[] = [
  ...
  { method: "POST", path: "/api/companion/open-in-browser", module: "server/management/companion-routes", mutates: false, exempt: { reason: "session-only", why: "Dashboard-only navigation helper; the GUI session opens its current view in the system browser, and there is no standalone CLI operation to drive." } },
